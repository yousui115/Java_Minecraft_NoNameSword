...
public class RenderNNSMagic extends Render
{
    ...
    {
        if (entity instanceof EntityNNSMagic)
        {
            doNNSMagicRender((EntityNNSMagic)entity, d0, d1, d2, f, f1);
        }
    }

    private void doNNSMagicRender(EntityNNSMagic entityMagic, double dX, double dY, double dZ, float f, float f1)
    {
        ...
        GL11.glRotatef(entityMagic.rotationYaw, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(-entityMagic.rotationPitch, 1.0F, 0.0F, 0.0F);
